-- Originally based on nvim-lua/kickstart.nvim
...
-- Show .env files and other files not shown due to .gitignore
...
require('lazy').setup({
  ...
  { -- Autoformat,
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        html = { 'htmlbeautifier' },
        eruby = { 'htmlbeautifier' }, -- For .html.erb files
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'ruby', 'typescript', 'vim', 'vimdoc' },
